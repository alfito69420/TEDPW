                ...
                <div class="col-md-4">
                    <div class="card border-0 text-center gray-bg">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">
                                Our farm-to-table concept emphasizes on getting the fresh produce directly from
                                local farms to your tables within one day, hence you know you get the freshest
                                produce straight from harvest.
                            </p>
                ...
                <div class="col-md-4">
                    <div class="card border-0 text-center gray-bg">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">
                                We want you to know exactly who is growing your food by having the farmers profile
                                on each item and farmers page. You’re welcome to visit the farms and see the love
                                they put into growing your food.
                            </p>
                ...
                <div class="col-md-4">
                    <div class="card border-0 text-center gray-bg">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">
                                Slowly but sure, by cutting the complex supply chain and food system, we hope to
                                improve the welfare of farmers by giving them the returns they deserve for their
                                hard work.
                            </p>
                        </div>
                    </div>
