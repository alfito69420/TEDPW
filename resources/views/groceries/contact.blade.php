                ...
                <div class="row mt-3">
                    <div class="col-lg-7">
                        <div class="contact-wrapper">
                            ...
                            <form action="{{ route('contact.store') }}" data-aos="fade-left" data-aos-duration="1200"
                                method="POST">
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <input name="fullname" value="{{ old('fullname') }}" class="form-control"
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <textarea name="message" value="{{ old('message') }}" class="form-control" rows="3" placeholder="Message"></textarea>
                                        </div>
                                    </div>
